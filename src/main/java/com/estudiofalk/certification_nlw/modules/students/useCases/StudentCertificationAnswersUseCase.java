package com.estudiofalk.certification_nlw.modules.students.useCases;
...
import com.estudiofalk.certification_nlw.modules.questions.entities.QuestionEntity;
import com.estudiofalk.certification_nlw.modules.questions.repositories.QuestionRepository;
...
import com.estudiofalk.certification_nlw.modules.students.entities.AnswersCertificationEntity;
import com.estudiofalk.certification_nlw.modules.students.entities.CertificationStudentEntity;
import com.estudiofalk.certification_nlw.modules.students.entities.StudentEntity;
import com.estudiofalk.certification_nlw.modules.students.repositories.CertificationStudentRepository;
import com.estudiofalk.certification_nlw.modules.students.repositories.StudentRepository;
...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {
        ...
        //Buscar as alternativas das perguntas - Correta/Incorreta
        ...
        dto.getQuestionsAnswers().stream().forEach(questionAnswer -> {
            ...
            var answersCertificationEntity = AnswersCertificationEntity.builder().answerID(questionAnswer.getAlternativeID())
        ...
        CertificationStudentEntity certificationStudentEntity = CertificationStudentEntity.builder()
                .technology(dto.getTechnology()).studentID(studentID).grade(correctAnswers.get())
                .build();
